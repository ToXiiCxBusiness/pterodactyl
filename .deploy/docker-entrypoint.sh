...
#php artisan p:environment:database --host=srv-captain--www-db --port=3306 --database=pterodactyl_panel --username=pterodactyl --password=QSYet2I80Gr2S64yS19iEWn7hiV
