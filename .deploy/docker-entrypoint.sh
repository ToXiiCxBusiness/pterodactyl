...
php artisan p:environment:database --host=srv-captain--www-db --port=3306 --database=pterodactyl_panel --username=pterodactyl --password="Q*^SYet2I80Gr2S64yS1&9iEWn7hiV"
